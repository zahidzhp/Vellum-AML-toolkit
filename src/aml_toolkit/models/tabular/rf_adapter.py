"""Random forest model adapter scaffold."""
...
class RandomForestAdapter(CandidateModel):
    """Adapter wrapping sklearn RandomForestClassifier."""

    def __init__(self, class_weight: str | None = None, seed: int = 42) -> None:
