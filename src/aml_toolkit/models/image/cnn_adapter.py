"""CNN model adapter scaffold (placeholder for Phase 9+ full training)."""
...
class CNNAdapter(CandidateModel):
    """Placeholder adapter for CNN-based image classification.
    ...
    def fit(self, X_train: Any, y_train: Any, X_val: Any, y_val: Any, config: ToolkitConfig) -> None:
        raise NotImplementedError("CNN training deferred to Phase 9.")

    def predict(self, X: Any) -> np.ndarray:
        raise NotImplementedError("CNN predict deferred to Phase 9.")

    def predict_proba(self, X: Any) -> np.ndarray | None:
        raise NotImplementedError("CNN predict_proba deferred to Phase 9.")

    def evaluate(self, X: Any, y: Any, metrics: list[str]) -> dict[str, float]:
        raise NotImplementedError("CNN evaluate deferred to Phase 9.")
    ...
    def serialize(self, path: Any) -> None:
        raise NotImplementedError("CNN serialize deferred to Phase 9.")
